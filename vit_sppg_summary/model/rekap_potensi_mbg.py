...
class rekap_potensi_mbg(models.Model):
    ...
    potensi_penerima_total = fields.Integer( string=_("Potensi Penerima Total"))
    total_penerima_mbg = fields.Integer(compute="_get_total", store=True,  string=_("Total Penerima Mbg"))
